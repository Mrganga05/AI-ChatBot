...
import { Eye, EyeOff, ArrowRight, Lock, Mail, User, Sparkles } from "lucide-react"
          ...
          <form onSubmit={handle} className="space-y-5">
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
              ...
              <div className="relative group">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-indigo-400 group-focus-within:text-pink-400 transition-colors" />
                <input
                  id="username"
                  required
                  value={username}
